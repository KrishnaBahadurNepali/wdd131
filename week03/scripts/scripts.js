document.addEventListener("DOMContentLoaded", () => {
    ...
    // Fetch weather data for Kathmandu, Nepal; to do this, I did created API keys openweather map API keys page
    fetch("https://api.openweathermap.org/data/2.5/weather?q=Kathmandu&units=metric&appid=fb12a6043dd45fc70a3b5cce4b5150d1")
        .then(response => response.json())
        .then(data => {
